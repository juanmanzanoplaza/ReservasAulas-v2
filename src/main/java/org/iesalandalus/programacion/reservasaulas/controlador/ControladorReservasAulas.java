...
/**
 * Clase controlador. Tiene el modelo y la vista de la aplicación como atributos, y llama a los métodos del que corresponda de cada uno.
...
public class ControladorReservasAulas implements IControladorReservasAulas {
	...
	/**
	 * Inicializa el controlador y guarda en los atributos la vsita y el modelo obtenidos como parámetros
	 ...
	 * @param insertar el aula que queremos insertar
	 ...
	 * @param borrar el aula a borrar
	 * @throws IllegalArgumentException si el aula es nula
	 * @throws OperationNotSupportedException si el aula a borrar no existe
	 */
	...
	/**
	 * Llama al método insertarProfesor del modelo con el profesor obtenido por parámetro
	 * @param insertar el profesor a insertar
	...
	/**
	 * Llama al método borrarProfesor del modelo con el profesor obtenido por parámetro
	 * @param borrar el profesor a borrar
	 * @throws IllegalArgumentException si el profesor es nulo
	...
	/**
	 * Llama al método buscarProfesor del modelo con el profesor obtenido por parámetro
	 * @param buscar el profesor a buscar
	 ...
	 * @return una colección con las reservas realizadas sobre el aula recibida como parámetro
	 * @throws IllegalArgumentException si el aula es nula
	 */
	 ...
	 * @param profesor el profesor a nombre del que están las reservas
	 * @return una colección con las reservas realizadas a nombre del profesor recibido como parámetro
	 * @throws IllegalArgumentException si el profesor es nulo
	 */
	 ...
	 * @param permanencia la permanencia para la que están hechas las reservas
	 * @return una colección con las reservas realizadas durante la permanencia recibida como parámetro
	 ...
	 * @param aula el aula que queremos comprobar si está disponible
	 * @param permanencia la permanencia sobre la que queremos consultar la disponibilidad
	 * @return true si el aula está disponible para esa permanencia, false si no lo está
	 * @throws IllegalArgumentException si el aula o la permanencia son nulas, o si el tipo de permanencia consultado no coincide con el de las reservas realizaddas sobre ese aula ese día
	 */
